...
const UserDetail = ({apiData}) => {
    ...
    details.push(["Director", detail.director])
    details.push(["Producer", detail.producer])
    details.push(["Release Date", detail.release_date])
    details.push(["RottenTomatoes Score", detail.rt_score])
